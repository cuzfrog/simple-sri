credentials += {
  ...
  else Credentials("Bintray API Realm", "api.bintray.com", bintrayUser, bintrayPass)
}
...
credentials += {
  ...
  else Credentials("Sonatype Nexus Repository Manager", "oss.sonatype.org", user, password)
}